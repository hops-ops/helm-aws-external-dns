...
PACKAGE ?= helm-aws-external-dns
XRD_DIR := apis/externaldns
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/externaldns/standard.yaml
...
EXAMPLES := \
    examples/externaldns/minimal.yaml:: \
    examples/externaldns/standard.yaml::
...
render\:%:
	@example="examples/externaldns/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
